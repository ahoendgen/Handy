...
const settingUpdaters: {
  ...
  audio_feedback_start: (value) =>
    commands.changeAudioFeedbackStartSetting(value as boolean),
  audio_feedback_stop: (value) =>
    commands.changeAudioFeedbackStopSetting(value as boolean),
  ...
  trigger_words_enabled: (value) =>
    commands.changeTriggerWordsEnabledSetting(value as boolean),
  trigger_words: (value) => commands.updateTriggerWords(value as any),
