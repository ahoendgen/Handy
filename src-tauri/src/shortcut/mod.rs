...
#[tauri::command]
#[specta::specta]
pub fn change_audio_feedback_start_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.audio_feedback_start = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_audio_feedback_stop_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.audio_feedback_stop = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
