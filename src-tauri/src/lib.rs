...
pub fn run() {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_trigger_words_enabled_setting,
        shortcut::update_trigger_words,
        shortcut::add_trigger_word,
        shortcut::update_trigger_word,
        shortcut::delete_trigger_word,
